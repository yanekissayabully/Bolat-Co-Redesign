...
//           <Link
//             href="#contact"
//             className="hidden md:inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2 text-sm font-semibold tracking-wide uppercase hover:bg-primary/90 transition-colors"
//           >
//             Оставить заявку
//           </Link>
//           <button
...
//               <Link
//                 href="#contact"
//                 className="inline-flex bg-primary text-primary-foreground px-5 py-2.5 text-sm font-semibold uppercase tracking-wide"
//               >
//                 Оставить заявку
//               </Link>
//             </li>
