...
//             <Link
//               href="#contact"
//               className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 text-sm font-semibold uppercase tracking-wide hover:bg-primary/90 transition-colors"
//             >
//               Связаться
